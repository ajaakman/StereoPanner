...
void StereoPannerAudioProcessorEditor::resized()
{
    ...
    sliderPanPosition->setBounds (72, 48, 224, 240);
...
<JUCER_COMPONENT documentType="Component" className="StereoPannerAudioProcessorEditor"
  ...
  <SLIDER name="new slider" id="366426ac080dbfbb" memberName="sliderPanPosition"
          virtualName="" explicitFocusOrder="0" pos="72 48 224 240" min="-1"
